 ...
 * @author vitorgreati
 */
public class FoodOutProcessor extends EntityProcessor<String> {

    public FoodOutProcessor(IORecordType ioType, ModelAbstractFactory modelAbstractFactory, EntityRecognizer entityRecognizer, EntityDAO entityDAO, IORecordDAO ioDAO) {
